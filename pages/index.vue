...
<template>
    <div class="space-y-24 h-[100%]">
        <header class="rounded-md flex flex-col-reverse md:flex-row md:items-center justify-center h-[100%] pb-20">
            <div class="md:w-8/12">
                <div class="space-y-6">
            ...
            <div class="flex flex-col rounded-lg relative space-x-2 space-y-5 p-2">
